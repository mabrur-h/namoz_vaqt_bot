...
BTN_TODAY, BTN_TOMORROW, BTN_MONTH, BTN_REGION = (
    '⌛️ Бугун', '⏳ Эртага', '📅 Тўлиқ тақвим', '🇺🇿 Минтақа')
...
def inline_callback(update, context):
    try:
        ...
        query.message.reply_html(text='<b>NAMOZ VAQTLARI</b> 🕐\n \nQuyidagilardan birini tanlang 👇',
